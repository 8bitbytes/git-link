...
exports.getSettingsWebviewContent = void 0;
const vscode = __importStar(require("vscode"));
function getSettingsWebviewContent(webview, settings, extensionUri, autoSaveMode = false) {
    ...
    // Define button styles based on auto-save mode
    const saveButtonStyle = autoSaveMode ? 'display: none;' : '';
    const cancelButtonText = autoSaveMode ? 'Close' : 'Cancel';
    return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="actions">
        <button id="save-button" style="${saveButtonStyle}" disabled>Save</button>
        <button id="cancel-button" class="secondary">${cancelButtonText}</button>
    </div>
